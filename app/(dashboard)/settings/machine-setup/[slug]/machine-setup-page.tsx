...
/**
 * /settings/machine-setup/[slug](/[machineId]) — "Open setup in Implexa" lands
 ...
 */
export default async function MachineSetupPage({ slug, machineId = null }: { slug: string; machineId?: string | null }) {
  ...
  return (
    <main className="min-h-screen px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <MachineSetupClient slug={slug} machineId={machineId} />
      </div>
    </main>
  );
}
