 ...
 *
 * Installed versions are read from the local Desktop bridge. Account-wide MCP
 * telemetry is not used because one account can be active on several Macs.
 */
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <PluginUpdateStatus
          ...
          updateCommand={plugin.update_command}
          notes={plugin.notes}
