...
export default async function SkillsPage({ searchParams }: { searchParams?: SkillsSearchParams }) {
  ...
  const { data: skills } = await supabase
    .from('org_skills')
    .select('id, slug, name, description, scope, status, usage_count, trigger_phrases, outcome_stats, tags, created_by, organization_id, forked_from_skill_id, created_at')
