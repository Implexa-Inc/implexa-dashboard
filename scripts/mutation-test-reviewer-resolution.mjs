...
const mutants = [
  ...
  ['disabled-resolution-source-fails-open', 'app/(dashboard)/_components/review-room.tsx',
    "  const resolutionsUnavailable = sources.reviewer_resolutions !== 'ready';",
    "  const resolutionsUnavailable = sources.reviewer_resolutions === 'unavailable';"],
  ['reviewer-resolution-source-not-contracted', 'lib/review.ts',
  ...
  ['omitted-per-issue-resolution-accepted', 'lib/review.ts',
