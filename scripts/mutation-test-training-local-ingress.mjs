...
const mutations = [
  ...
  ['adopted-active-requirements-identity', componentPath, 'isManagerTrainingRequirements(managerTrainingRequirements, currentVersion);', 'isManagerTrainingRequirements(managerTrainingRequirements, sessionVersion || currentVersion);'],
