...
const mutations = [
  ...
  ['review-artifact-picker', 'an external review target silently falls back to the original run lineage', COMPONENT,
    ...
    "const effectiveRevisionMode = hasExternalReviewTarget ? 'inherit' : revisionMode;"],
  ['review-artifact-picker', 'ordinary review silently inherits an incomplete original-run input contract', COMPONENT,
