...
function fixture() {
  return {
    ...
    requirements: [
      { id: 'cli', requirement_type: 'local_cli', required: true, permission_category: 'source_control_read', reactivation_on_change: true,
      ...
      { id: 'mcp', requirement_type: 'mcp_server', required: true, permission_category: 'data_read', reactivation_on_change: true,
      ...
      { id: 'api', requirement_type: 'api_credential', required: false, permission_category: 'paid_provider', reactivation_on_change: true,
